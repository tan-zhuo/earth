...
- 地形起伏（NOAA ETOPO1）：山脉与海底地形按真实高程做**顶点位移**（球面细分到 900×450，地平线上能看出山体轮廓与遮挡）+ 山体阴影，垂直夸张 ×1~×60 可调，开启后可贴近地表观察；国界改为贴着地形走的折线，悬停/选中的高亮直接画进地表（不再是悬空的平顶盖）；「高程着色」按海拔/水深上色并附色带图例；指针悬停实时读出该点海拔/水深
