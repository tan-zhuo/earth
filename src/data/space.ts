...
export const PLANETS: PlanetDef[] = [
  ...
  },
  {
    ...
    facts: planetFacts('木星', 'Jupiter', ['太阳系最大的行星', 'Largest planet in the Solar System'],
      '139,820', '5.20', ['11.9 年', '11.9 years'], ['9 小时 56 分', '9h 56m'], '115 · 2026-08',
  ...
  },
  {
    ...
    facts: planetFacts('土星', 'Saturn', ['拥有壮丽光环的气态巨行星', 'The ringed gas giant'],
      '116,460', '9.58', ['29.5 年', '29.5 years'], ['10 小时 33 分', '10h 33m'], '293 · 2026-08',
  ...
  },
  {
    ...
    facts: planetFacts('天王星', 'Uranus', ['躺着自转的冰巨星', 'The sideways ice giant'],
      '50,724', '19.2', ['84 年', '84 years'], ['17 小时 14 分（逆向）', '17h 14m (retrograde)'], '29 · 2026-08',
...
export const UNIVERSE_FACTS: SpaceFacts = {
  ...
  rows: [
    ...
    { labelZh: '星系数量', labelEn: 'Galaxies', valueZh: '估计数千亿至数万亿个', valueEn: 'Hundreds of billions to trillions (estimated)' },
