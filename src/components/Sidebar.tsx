      ...
      >
        ...
        <div className="border-t border-slate-700/40 p-3">
          ...
          <div className="flex justify-center gap-3 text-xs text-slate-500">
            <a href="https://tanzhuo.xyz" target="_blank" rel="noopener noreferrer" className="transition hover:text-sky-300">
              {t('authorBlog')}
            </a>
            <span className="text-slate-700">|</span>
            <a href="https://github.com/tan-zhuo/earth" target="_blank" rel="noopener noreferrer" className="transition hover:text-sky-300">
              GitHub
            </a>
          </div>
        </div>
